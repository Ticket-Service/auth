...
See https://github.com/Ticket-Service/auth/blob/master/examples/main.go to see this in action.
*/
package gothic
...
See https://github.com/Ticket-Service/auth/examples/main.go to see this in action.
*/
